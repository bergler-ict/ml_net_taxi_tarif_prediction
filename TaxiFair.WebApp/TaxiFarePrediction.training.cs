...
namespace TaxiFair.WebApp
{
    public partial class TaxiFarePrediction
    {
        public const string RetrainFilePath = @"C:\Users\mslegt\sources\TaxiFair\TaxiFairTrainer\Data\taxi-fare-train.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new[] { new InputOutputColumnPair(@"vendor_id", @"vendor_id"), new InputOutputColumnPair(@"payment_type", @"payment_type") }, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)
                                    ...
                                    .Append(mlContext.Regression.Trainers.LightGbm(new LightGbmRegressionTrainer.Options() { NumberOfLeaves = 65, NumberOfIterations = 4, MinimumExampleCountPerLeaf = 20, LearningRate = 0.9999997766729865, LabelColumnName = @"fare_amount", FeatureColumnName = @"Features", Booster = new GradientBooster.Options() { SubsampleFraction = 0.5258555719682717, FeatureFraction = 0.9808750598964956, L1Regularization = 2E-10, L2Regularization = 0.44463865875267383 }, MaximumBinCountPerFeature = 241 }));
